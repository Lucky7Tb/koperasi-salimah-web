	...
	<div class="site-width">
		<nav class="navbar navbar-expand-lg  p-0">
			<div class="navbar-header  h-150 h4 mb-0 align-self-center logo-bar text-left" style="background-color: #491369;">
				<a href="<?= base_url(index_page() . '/admin') ?>" class="horizontal-logo">
					<div class="media">
						...
						<ul class="dropdown-menu dropdown-menu-right border  py-0">
							<li>
								<a class="dropdown-item px-2 py-2 border border-top-0 border-left-0 border-right-0" href="#">
									<div class="media">
										<img src="<?= base_url('dist') ?>/images/author.jpg" alt="" class="d-flex mr-3 img-fluid rounded-circle">
							...
							<li>
								<a class="dropdown-item px-2 py-2 border border-top-0 border-left-0 border-right-0" href="#">
									<div class="media">
										<img src="<?= base_url('dist') ?>/images/author3.jpg" alt="" class="d-flex mr-3 img-fluid rounded-circle">
										<div class="media-body">
											<p class="mb-0">Bill</p>
					...
					<li class="dropdown align-self-center d-inline-block">
						...
						<ul class="dropdown-menu dropdown-menu-right border   py-0">
							<li>
								<a class="dropdown-item px-2 py-2 border border-top-0 border-left-0 border-right-0" href="#">
									<div class="media">
										<img src="<?= base_url('dist') ?>/images/author.jpg" alt="" class="d-flex mr-3 img-fluid rounded-circle w-50">
										<div class="media-body">
							...
							<li>
								<a class="dropdown-item px-2 py-2 border border-top-0 border-left-0 border-right-0" href="#">
									<div class="media">
										<img src="<?= base_url('dist') ?>/images/author2.jpg" alt="" class="d-flex mr-3 img-fluid rounded-circle">
										<div class="media-body">
			...
			<div class="col-12  align-self-center">
				<div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
					...
					<ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
						<li class="breadcrumb-item"><a href="<?= base_url(index_page().'/admin') ?>">Dashboard</a></li>
			...
			<div class="col-12 mt-3">
				<div class="card">
					<div class="card-header  justify-content-between align-items-center">
						<a type="button" class="btn btn-primary" href="<?= base_url(index_page().'/admin/list_produk') ?>">Kembali</a>
					</div>
					<div class="card-body">
							...
							<div class="col-12 col-sm-8">
								<form method="post">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="number" class="form-control" id="harga" placeholder="Rp 00.000,00" name="harga" value="<?= set_value('harga')?>">
										</div>
									</div>
									<div class="form-group row">
									...
									<div class="form-group row">
										...
										<div class="col-sm-10">
											<input type="number" class="form-control" id="stok" placeholder="000" name="stok" value="<?= set_value('stok') ?>">
										</div>
									</div>
									<div class="form-group row">
...
<!-- START: Page Vendor JS-->
<script src="<?= base_url('dist') ?>/vendors/dropzone/dropzone.js"></script>
<!-- END: Page Vendor JS-->
</body>
<!-- END: Body-->
