...
<head>
	...
	<link rel="stylesheet" href="<?= base_url('dist') ?>/dist/vendors/jquery-ui/jquery-ui.theme.min.css">
	...
	<!-- START: Page CSS-->
	<link rel="stylesheet" href="<?= base_url('dist') ?>/dist/vendors/chartjs/Chart.min.css">
	<!-- END: Page CSS-->

	<!-- START: Page CSS-->
	<link rel="stylesheet" href="<?= base_url('dist') ?>/vendors/themify-icons/themify-icons.css">
	<link rel="stylesheet" href="<?= base_url('dist') ?>/vendors/sweetalert/sweetalert.css">
	<!-- END: Page CSS-->
		...
		<nav class="navbar navbar-expand-lg  p-0">
			<div class="navbar-header  h-150 h4 mb-0 align-self-center logo-bar text-left" style="background-color: #491369;">
				<a href="http://localhost/Salimah_CI/admin/dashboard" class="horizontal-logo">
					<div class="media">
						<img src="<?= base_url('img') ?>/tes4.png" alt="" class="d-flex img-fluid" width="200">
				...
				<ul class="ml-auto p-0 m-0 list-unstyled d-flex top-icon h-100">
					...
					<li class="dropdown user-profile align-self-center d-inline-block">
						...
						<div class="dropdown-menu border dropdown-menu-right p-0">
							<a href="http://localhost/Salimah_CI/admin/profil_admin"
	...
	<div class="site-width">
		...
		<ul id="side-menu" class="sidebar-menu">
			<li class="dropdown active"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>
				<ul>
					<li><a href="<?= base_url(index_page().'/admin') ?>" style="color: white;"><i class="icon-home"></i>
							Dashboard</a></li>
					<li class="active"><a href="http://localhost/Salimah_CI/admin/list_produk"><i class="icon-bag"></i> List
							Produk</a>
					</li>
					<li><a href="http://localhost/Salimah_CI/admin/list_akun_admin" style="color: white;"><i
								class="icon-people"></i> List Akun
							Admin</a></li>
					<li><a href="http://localhost/Salimah_CI/admin/list_pesanan" style="color: white;"><i
								class="icon-basket-loaded"></i> List
							Pesanan</a></li>
					<li><a href="http://localhost/Salimah_CI/admin/list_metode_pembayaran" style="color: white;"><i
								class="icon-credit-card"></i>
							List Metode Pembayaran</a>
					</li>
					<li><a href="http://localhost/Salimah_CI/admin/grafik_penjualan" style="color: white;"><i
								class="icon-chart"></i> Grafik Penjualan</a></li>
...
<main>
			...
			<div class="col-12  align-self-center">
				<div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
					...
					<ol class="breadcrumb bg-transparent align-self-center m-0 p-0">
						<li class="breadcrumb-item"><a href="<?= base_url(index_page().'/admin/product/') ?>">Produk</a></li>
			...
			<div class="col-12 mt-3">
				<div class="card">
					<div class="card-header  justify-content-between align-items-center">
						<a type="button" class="btn btn-primary" href="<?= base_url(index_page().'/admin/tambah_produk') ?>">Tambah
							Produk</a>
					</div>
					<div class="card-body">
	...
	<!-- Modal -->
	<div class="modal fade" id="hapusProdukModal" tabindex="-1" role="dialog" aria-labelledby="hapusProdukModal"
			 aria-hidden="true">
...
<script src="<?= base_url('dist') ?>/vendors/sweetalert/sweetalert.min.js"></script>
<!-- END: Page Vendor JS-->

<!-- START: Page Script JS-->
<script src="<?= base_url('dist') ?>/js/sweetalert.script.js"></script>
<!-- END: Page Script JS-->

<!-- START: Page Vendor JS-->
<script src="<?= base_url('dist') ?>/vendors/raphael/raphael.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/morris/morris.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/chartjs/Chart.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/starrr/starrr.js"></script>
<script src="<?= base_url('dist') ?>/vendors/jquery-flot/jquery.canvaswrapper.js"></script>
<script src="<?= base_url('dist') ?>/vendors/jquery-flot/jquery.colorhelpers.js"></script>
<script src="<?= base_url('dist') ?>/vendors/jquery-flot/jquery.flot.js"></script>
<script src="<?= base_url('dist') ?>/vendors/jquery-flot/jquery.flot.saturated.js"></script>
<script src="<?= base_url('dist') ?>/vendors/jquery-flot/jquery.flot.browser.js"></script>
<script src="<?= base_url('dist') ?>/vendors/jquery-flot/jquery.flot.drawSeries.js"></script>
<script src="<?= base_url('dist') ?>/vendors/jquery-flot/jquery.flot.uiConstants.js"></script>
<script src="<?= base_url('dist') ?>/vendors/jquery-flot/jquery.flot.legend.js"></script>
<script src="<?= base_url('dist') ?>/vendors/jquery-flot/jquery.flot.pie.js"></script>
<script src="<?= base_url('dist') ?>/vendors/chartjs/Chart.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/jquery-jvectormap/jquery-jvectormap-2.0.3.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/jquery-jvectormap/jquery-jvectormap-world-mill.js"></script>
<script src="<?= base_url('dist') ?>/vendors/jquery-jvectormap/jquery-jvectormap-de-merc.js"></script>
<script src="<?= base_url('dist') ?>/vendors/jquery-jvectormap/jquery-jvectormap-us-aea.js"></script>
<script src="<?= base_url('dist') ?>/vendors/apexcharts/apexcharts.min.js"></script>
<!-- END: Page Vendor JS-->

<!-- START: Page JS-->
<script src="<?= base_url('dist') ?>/js/home.script.js"></script>
<!-- END: Page JS-->

<!-- START: Page Vendor JS-->
<script src="<?= base_url('dist') ?>/vendors/datatable/js/jquery.dataTables.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/datatable/js/dataTables.bootstrap4.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/datatable/jszip/jszip.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/datatable/pdfmake/pdfmake.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/datatable/pdfmake/vfs_fonts.js"></script>
<script src="<?= base_url('dist') ?>/vendors/datatable/buttons/js/dataTables.buttons.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/datatable/buttons/js/buttons.bootstrap4.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/datatable/buttons/js/buttons.colVis.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/datatable/buttons/js/buttons.flash.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/datatable/buttons/js/buttons.html5.min.js"></script>
<script src="<?= base_url('dist') ?>/vendors/datatable/buttons/js/buttons.print.min.js"></script>
<!-- END: Page Vendor JS-->

<!-- START: Page Script JS-->
<script src="<?= base_url('dist') ?>/js/datatable.script.js"></script>
<!-- END: Page Script JS-->
</body>
<!-- END: Body-->
