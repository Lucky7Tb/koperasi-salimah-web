...
<body id="main-container" class="default">
        ...
        <div class="site-width">
            ...
            <ul id="side-menu" class="sidebar-menu">
                <li class="dropdown active"><a href="#"><i class="icon-home mr-1"></i> Dashboard</a>
                    <ul>
                        <li class="active"><a href="<?= base_url(index_page().'/admin') ?>"><i class="icon-home"></i> Dashboard</a></li>
                        <li><a href="<?= base_url(index_page().'/admin/product/') ?>" style="color: white;"><i class="icon-bag"></i> List Produk</a>
                        </li>
                        <li><a href="<?= base_url(index_page().'/admin/user/') ?>" style="color: white;"><i class="icon-people"></i> List Akun
                                Admin</a></li>
                        <li><a href="<?= base_url(index_page().'/admin/payment/') ?>" style="color: white;"><i class="icon-basket-loaded"></i> List
                                Pesanan</a></li>
                        <li><a href="<?= base_url(index_page().'/admin/delivery/') ?>" style="color: white;"><i class="icon-credit-card"></i>
                                List Metode Pembayaran</a>
                        </li>
                        <li><a href="<?= base_url(index_page().'/admin/grafik_penjualan') ?>" style="color: white;"><i class="icon-chart"></i> Grafik Penjualan</a></li>
    ...
    <main>
        ...
        <div class="footer">
            <div class="footer2">
                <a class="" href="#">
                    <img src="<?= base_url('img') ?>/tes4.png" width="240" alt="" loading="lazy">
                </a>
            </div>
            <div class="">
