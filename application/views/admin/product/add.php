					...
					<form class="row col-12" method="post" enctype="multipart/form-data">
						...
						<div class="col-12 col-sm-8">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="harga" placeholder="Rp 00.000,00" name="price">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="stok" placeholder="000" name="stock">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="weight" placeholder="000" name="weight">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<textarea name="description" id="deskripsi" cols="80" rows="5" class="form-control"></textarea>
